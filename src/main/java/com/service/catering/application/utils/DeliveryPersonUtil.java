...
public class DeliveryPersonUtil {
  ...
  public static DeliveryPersonEntity DeliberyPersonDtoToDeliveryPersonEntity(DeliveryPersonDto deliveryPersonDto) {
  ...
  public static DeliveryPersonDto DeliveryPersonEntityToDeliberyPersonDto(DeliveryPersonEntity deliveryPersonEntity) {
