...
public class ProducerEventDeliveryUpdateStatusFoodPackageService extends BaseService {
  ...
  @Autowired
  private DeliveryPersonServiceRepository deliveryPersonServiceRepository;


  public void producerDeliveryUpdate(DeliveryEntity deliveryEntity, HistoryDeliveryEntity historyDeliveryEntity) {
	...
	FoodPackageEntity foodPackageEntity = foodPackageServiceRepository.queryFoodPackageById( deliveryEntity.getFoodPackageId() );
	DeliveryPersonEntity deliveryPersonEntity = deliveryPersonServiceRepository.queryDeliveryPersonById( deliveryEntity.getDeliveryPersonId() );
	...
	log.info( this.getClass(), "producerEvent " + EVENT_DELIVERY_UPDATE_STATUS + " registrado: " + producerEntity.getBody() );
  }
}
