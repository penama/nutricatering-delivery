...
public class ConsumerEventFoodPackageService extends BaseService {
  ...
  public static final String FOODS = "foods";
   ...
   @Autowired
   private FoodPackageServiceRepository foodPackageServiceRepository;
  ...
  public void foodPackageNewEvent( EventDto eventDto ) throws  Exception {
	  ...
	  FoodPackageEntity foodPackageEntityBd = foodPackageServiceRepository.queryFoodPackageById( foodPackageEntity.getId() );
	  if ( foodPackageEntityBd != null ){
		  log.error( this.getClass(), "Evento foodPackageCookingEvent, FoodPackageId = " + foodPackageEntity.getId() + ", ya existe en la base" );
		  return;
	  }
	  ...
	  log.info( this.getClass(), "Evento foodPackageNewEvent, FoodPackageId = " + foodPackageEntity.getId() + ", registrado" );
  }
	...
	public void foodPackageCookingEvent( EventDto eventDto ) throws  Exception {
		...
		FoodPackageEntity foodPackageEntityBd = foodPackageServiceRepository.queryFoodPackageById( foodPackageEntity.getId() );
		if ( foodPackageEntityBd == null ){
			log.error( this.getClass(), "Evento foodPackageCookingEvent, FoodPackageId = " + foodPackageEntity.getId() + ", no existe en la base" );
			return;
		}
		foodPackageEntity.setStatusDelivery(  foodPackageEntityBd.getStatusDelivery() );
		foodPackageServiceRepository.newFoodPackage( foodPackageEntity );
		log.info( this.getClass(), "Evento foodPackageNewEvent, FoodPackageId = " + foodPackageEntity.getId() + ", actualizado" );
	}
	...
	public void foodPackageCookedEvent( EventDto eventDto ) throws  Exception {
		...
		FoodPackageEntity foodPackageEntityBd = foodPackageServiceRepository.queryFoodPackageById( foodPackageEntity.getId() );
		if ( foodPackageEntityBd == null ){
			log.error( this.getClass(), "Evento foodPackageCookedEvent, FoodPackageId = " + foodPackageEntity.getId() + ", no existe en la base" );
			return;
		}
		foodPackageEntity.setStatusDelivery(  foodPackageEntityBd.getStatusDelivery() );
		foodPackageServiceRepository.newFoodPackage( foodPackageEntity );
		log.info( this.getClass(), "Evento foodPackageCookedEvent, FoodPackageId = " + foodPackageEntity.getId() + ", actualizado" );
	}
	...
	public void foodPackagePackedEvent( EventDto eventDto ) throws  Exception {
		...
		FoodPackageEntity foodPackageEntityBd = foodPackageServiceRepository.queryFoodPackageById( foodPackageEntity.getId() );
		if ( foodPackageEntityBd == null ){
			log.error( this.getClass(), "Evento foodPackagePackedEvent, FoodPackageId = " + foodPackageEntity.getId() + ", no existe en la base" );
			return;
		}
		foodPackageEntity.setStatusDelivery(  foodPackageEntityBd.getStatusDelivery() );
		foodPackageServiceRepository.newFoodPackage( foodPackageEntity );
		log.info( this.getClass(), "Evento foodPackagePackedEvent, FoodPackageId = " + foodPackageEntity.getId() + ", actualizado" );
	}
	...
	public void foodPackageDispatchedEvent( EventDto eventDto )throws  Exception {
		...
		FoodPackageEntity foodPackageEntityBd = foodPackageServiceRepository.queryFoodPackageById( foodPackageEntity.getId() );
		if ( foodPackageEntityBd == null ){
			log.error( this.getClass(), "Evento foodPackageDispatchedEvent, FoodPackageId = " + foodPackageEntity.getId() + ", no existe en la base" );
			return;
		}
		foodPackageEntity.setStatusDelivery(  foodPackageEntityBd.getStatusDelivery() );
		foodPackageServiceRepository.newFoodPackage( foodPackageEntity );
		log.info( this.getClass(), "Evento foodPackageDispatchedEvent, FoodPackageId = " + foodPackageEntity.getId() + ", actualizado" );
	}
