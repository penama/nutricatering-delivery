...
public class DeliveryPersonService extends BaseCommandHandler {
  ...
  public DeliveryPersonDto newDeliveryPerson(DeliveryPersonDto deliveryPersonDto) throws Exception {
    DeliveryPersonEntity deliveryPersonEntity = DeliveryPersonUtil.DeliberyPersonDtoToDeliveryPersonEntity( deliveryPersonDto );
    commandHandler(this, deliveryPersonEntity);
	DeliveryPersonDto deliveryPersonDtoNew = DeliveryPersonUtil.DeliveryPersonEntityToDeliberyPersonDto( deliveryPersonEntity );
	return deliveryPersonDtoNew;
  }

  public List<DeliveryPersonDto> getDeliveryPersons() throws Exception {
    List<DeliveryPersonEntity> deliveryPersonEntities = iQueryDeliveryPersonRepository.queryDeliveryPersons();
    ...
    for (DeliveryPersonEntity deliveryPersonEntity : deliveryPersonEntities) {
      deliveryPersonDtos.add(DeliveryPersonUtil.DeliveryPersonEntityToDeliberyPersonDto( deliveryPersonEntity) );
    }
    return deliveryPersonDtos;
  }

  public DeliveryPersonDto getDeliveryPersonById(String deliveryPersonId) throws Exception {
    DeliveryPersonEntity deliveryPersonEntity = iQueryDeliveryPersonRepository.queryDeliveryPersonById( deliveryPersonId );
	DeliveryPersonDto deliveryPersonDto = DeliveryPersonUtil.DeliveryPersonEntityToDeliberyPersonDto( deliveryPersonEntity );
